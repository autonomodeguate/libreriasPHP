	...
	if(isset($_POST['submit'])){
		...
		$estado = $_POST['estado'];
			...
			if($producto->guardar())
			{
				...
				redireccionar_a("add-product2.php?message={$message}&id=".$producto->menu_id);
			}
			else
			{
		...
		<header id="header" class="clearfix">
			...
			<nav id="access">
				<ul>
					...
					<li><a class="selected" href="add-product2.php">Agregar Producto</a></li>
