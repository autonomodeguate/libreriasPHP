...
defined("RAIZ_DIR") ? NULL : define("RAIZ_DIR","D:".SD."wamp".SD."www".SD."imedics");/*Marcamos la ruta directa a la carpeta raiz*/

//defined("RAIZ_DIR") ? NULL : define("RAIZ_DIR","D:".SD."hshome".SD."c298229".SD."imedics.ws");
...
require_once(LIB_DIR.SD.'seller.php');
...
require_once(LIB_DIR.SD.'sales.php');
