...
<?php 
	...
	if(!isset($_GET['speciality']) || empty($_GET['speciality'])){ redireccionar_a("medicines.php"); }	
	$i = 0;
?>
		...
		<div id="content" class="clearfix">
			...
			<div id="center">
				<div style="text-align:center;width:100%;">
					<?php $speciality = speciality::buscar_por_id($_GET['speciality']); ?>
				...
				<div class="menu clearfix">
					<ul>
						...
						<li><a href="#"><?php echo $sal->nombre; ?></a>
							<?php $medicamentos = medicament::medicamentos_por_especialidad_sal($sal->id,$_GET['speciality']); ?>
