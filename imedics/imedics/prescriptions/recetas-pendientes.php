...
<?php
	...
	$recetas = prescription::recetas_pendientes();
...
<head>
	...
	<title>Recetas Pendientes - iMedics.ws</title>
		...
		<header id="header" class="clearfix">
			...
			<nav id="access">
				<ul>
					...
					<li><a class="selected" href="recetas-negativas.php">Recetas Negativas</a></li>
					<li><a href="recetas-pendientes.php">Recetas Pendientes</a></li>
				...
				<?php if(count($recetas) != 0){ ?>
					<?php foreach($recetas as $receta){ ?>
						<tr>
							...
							<td><?php echo htmlentities($medico->nombre); ?></td>
							<td><?php echo htmlentities($receta->paciente); ?></td>
