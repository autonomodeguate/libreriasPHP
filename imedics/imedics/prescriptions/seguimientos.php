...
<?php
	...
	$recetas = prescription::recetas_seguimiento();
...
<head>
	...
	<title>Administración de Recetas - iMedics.ws</title>
		...
		<header id="header" class="clearfix">
			...
			<nav id="access">
				<ul>
					...
					<li><a class="selected" href="seguimientos.php">Seguimientos</a></li>
			...
			<table width="100%">
				...
				<?php if(count($recetas) != 0){ ?>
					...
					<tr>
						...
						<td><?php if($receta->estado == 'positivo'){ echo " <span class='positivo'>Positivo</span>";} ?><?php if($receta->estado == 'negativo'){ echo " <span class='negativo'>Negativo</span>";} ?> <?php if($receta->estado == 'pendiente'){ echo " <span class='pendiente'>Pendiente</span>";} ?> <?php if($receta->estado == 'seguimiento'){ echo " <span class='seguimiento'>Seguimiento</span>";} ?></td>
						<td><a href="view-prescription.php?prescription=<?php echo urlencode($receta->id); ?>">Ver</a></td>
					</tr>
					<?php } ?>
				<?php }else{?>
				<tr>
					<td colspan="6">Por el momento no hay recetas pendientes de seguimiento.</td>
				</tr>
				<?php } ?>
			</table>
